          ...
          <CardBody>
            <Stack hasGutter>
              ...
              <StackItem key={ 'request-requester' }>
                <TextContent>
                  <Text component={ TextVariants.small }>{ intl.formatMessage(requestsMessages.requesterColumn) }</Text>
              ...
              <StackItem key={ 'request-order' }>
                <TextContent>
                  <Text component={ TextVariants.small }>{ intl.formatMessage(requestsMessages.orderNumber) }</Text>
