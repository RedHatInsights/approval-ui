...
describe('Request actions', () => {
  ...
  it('should dispatch correct actions after fetching one request', () => {
    ...
    apiClientMock.get(APPROVAL_API_BASE + '/requests/?page_size=50&page=1', mockOnce({
      body: {
        data: [{
          id: '111',
          name: ''
    ...
    apiClientMock.get(APPROVAL_API_BASE + '/requests/111/?extra=true', mockOnce({
      body: {
        data: [{
          id: '123',
          name: ''
    ...
    apiClientMock.get(`${APPROVAL_API_BASE}/requests/111/`, mockOnce(200, {
      data: {
        requests: [
          {
            id: '123',
